...
old_html = """    <!-- Floating Quick Menu -->
    <div class="quick-menu">
        <div class="quick-item" title="네이버 예약">
            <i data-lucide="calendar-check"></i>
            <span>네이버 예약</span>
        </div>
        <div class="quick-item" title="블로그">
            <i data-lucide="layout"></i>
            <span>블로그</span>
        </div>
        <div class="quick-item" title="톡톡 상담">
            <i data-lucide="message-square"></i>
            <span>톡톡 상담</span>
        </div>
        <div class="quick-item" title="카카오톡">
            <i data-lucide="message-circle"></i>
            <span>카카오톡</span>
        </div>
        <div class="quick-item" title="인스타그램">
            <i data-lucide="instagram"></i>
            <span>인스타그램</span>
        </div>
    </div>"""

new_html = """    <!-- Floating Quick Menu -->
    <div class="quick-menu">
...
for filepath in glob.glob("*.html"):
    ...
    if old_html in content:
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(content)
        count += 1
print(f"Replaced quick menu in {count} HTML files.")
